...
- prompt: node .codex/skills/context7-auto-research/context7-api.js search "<library-name>" "<user-query>"
```
...
Prompt: node .codex/skills/context7-auto-research/context7-api.js search "next.js" "How to configure middleware in Next.js 15"
```
...
- prompt: node .codex/skills/context7-auto-research/context7-api.js context "<library-id>" "<specific-query>"
```
...
Prompt: node .codex/skills/context7-auto-research/context7-api.js context "/vercel/next.js" "middleware configuration"
```
...
```bash
# In .codex/skills/context7-auto-research/.env
