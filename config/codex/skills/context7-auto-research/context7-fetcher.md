...
```bash
# Search libraries
node .codex/skills/context7-auto-research/context7-api.js search "react" "useEffect hook"

# Get documentation
node .codex/skills/context7-auto-research/context7-api.js context "/facebook/react" "useEffect cleanup"

# Documentation query with version
node .codex/skills/context7-auto-research/context7-api.js context "/vercel/next.js/v15.1.8" "middleware"
```
